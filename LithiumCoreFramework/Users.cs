...
//            /*
//            List<List<string>> delegateLoads(int thr)
//            {
...
//                foreach (var load in new WorkController().Seperate(members, threads))
//                {
...
//                        else
//                        {
//                            core.WriteLine(Color.Lime, $"Failed to ban {member}");
//                            Load.Remove(member); // remove the member
//                        }
//                    }
//                }
